    ...
    for refDir in caseDirs:
        ...
        for caseDir in caseDirs:
            if caseDir != refDir:
                ...
                # Do this for both hier & DB
                for clusterType in ["hier", "dbscan"]:
                    ...
                    refCases = 0
                    refFiles = glob.glob( refDir+"/analysis/structures/cluster/cluster_"+clusterType+"_centroid.c*.pdb" )     
                    for refFile in sorted(refFiles, key=numericalSort):
                        if refCases < showClusters:
                            ...
                            caseCases = 0
                            caseFiles = glob.glob( caseDir+"/analysis/structures/cluster/cluster_"+clusterType+"_centroid.c*.pdb" )
                    ...
                    if data != []:
                        ...
                        # Save data to file
                        plotName = clusterType+"_"+refDir.split("/")[-1]+"_vs_"+caseDir.split("/")[-1]+"_clusterRmsdMap"
